...
export type AgentModelProvider = 'openai' | 'anthropic' | 'google' | 'bedrock'
...
export const AGENT_MODEL_DEFINITIONS = {
	// Claude via Amazon Bedrock (IDs must match your region / inference profile; aligned with app default)
	'claude-sonnet-4-5': {
	...
	// Verify this inference/model ID in the Bedrock console for your AWS region.
	'claude-opus-4-5': {
